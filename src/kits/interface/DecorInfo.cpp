...
DecorInfo::_Init(bool isUpdate)
{
	...
	if (fPath == "Default") {
		...
		fAuthors = "Ferhat Gecdogan, DarkWyrm, Stephan Aßmus, Clemens Zeidler, Ingo Weinhold";
		fLongDescription = fShortDescription;
		fLicenseURL = "http://";
		fLicenseName = "MIT";
		fSupportURL = "https://fegeyaosproject.blogspot.com/";
		fVersion = 0.1;
		fInitStatus = B_OK;
		...
		fShortDescription = gSystemCatalog.GetString(B_TRANSLATE_MARK(
				"Default FegeyaOS window decorator."),
			B_TRANSLATION_CONTEXT);
