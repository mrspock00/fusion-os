	...
	fLastCompletedTimerId(0)
{
	...
	float col0width = be_plain_font->StringWidth(kTitleEnabled);
	float col1width = be_plain_font->StringWidth(kTitleName);
	float col2width = be_plain_font->StringWidth(kTitleUrl);
	fListView->AddColumn(new BStringColumn(kTitleEnabled, col0width, col0width,
		2 * col0width, B_TRUNCATE_END), kEnabledColumn);
	fListView->AddColumn(new BStringColumn(kTitleName, 0, col1width, 0,
		B_TRUNCATE_END), kNameColumn);
	fListView->AddColumn(new BStringColumn(kTitleUrl, 0, col2width, 0,
