		...
		| B_NOT_MINIMIZABLE | B_AUTO_UPDATE_SIZE_LIMITS)
{
	...
	infoText << B_TRANSLATE(
		"Welcome to the FegeyaOS Installer!\n\n");
	infoText << B_TRANSLATE(
		"IMPORTANT INFORMATION BEFORE INSTALLING FEGEYAOS\n\n");
	infoText << B_TRANSLATE(
		"This is beta-quality software! It means there is a risk of "
		"losing important data. Make frequent backups! You have been "
		"warned.\n\n\n");
	infoText << B_TRANSLATE(
		"1)   If you are installing FegeyaOS onto real hardware (not inside an "
	...
	infoText << "\n\n\n";
	infoText << B_TRANSLATE(
		"2)   The Installer will make the FegeyaOS partition itself bootable, "
		"but takes no steps to integrate Fegeya into an existing boot menu. "
		"If you have GRUB already installed, you can add FegeyaOS to it.\n"
		"For details, please consult the guide on booting FegeyaOS on our "
		"website at \n"
		"Or you can set up a boot menu from Installer's \"Tools\" menu, see "
		"the Userguide's topic on the application \"BootManager\".\n\n\n");
	infoText << B_TRANSLATE(
		"3)   When you successfully boot into FegeyaOS for the first time, make "
		"sure to read our \"Welcome\" and \"Userguide\" documentation. There "
		"are links on the Desktop and in WebPositive's bookmarks.\n\n");
	infoText << B_TRANSLATE(
		"Have fun and thanks for trying out FegeyaOS!");
